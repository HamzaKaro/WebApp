...
class BlogUploadImageScreen extends StatefulWidget {
  const BlogUploadImageScreen({Key? key}) : super(key: key);
  static Route get route => MaterialPageRoute(
        builder: (context) => const BlogUploadImageScreen(),
      );
  @override
  _BlogUploadImageScreenState createState() => _BlogUploadImageScreenState();
}

class _BlogUploadImageScreenState extends State<BlogUploadImageScreen> {
  File? _photo;
  ...
  Future imgFromGallery() async {
    ...
    setState(() {
      if (pickedFile != null) {
        ...
        log(translate("upload_avatar.no_image_selected"));
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(translate('blog.upload_cover_image')),
      ),
      body: Container(
