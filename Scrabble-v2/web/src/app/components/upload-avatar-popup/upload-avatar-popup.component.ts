...
@Component({
    selector: 'app-upload-avatar-popup',
    templateUrl: './upload-avatar-popup.component.html',
    styleUrls: ['./upload-avatar-popup.component.scss'],
})
export class UploadAvatarPopupComponent {
    ...
    constructor(private dialogRef: MatDialogRef<UploadAvatarPopupComponent>, private uploadService: FileUploadService) {
