...
const DB_PASSWORD = 'MZYz1cLAtdG7tcjO';
const DATABASE_URL = `mongodb+srv://${DB_USERNAME}:${DB_PASSWORD}@cluster0.hcvlexs.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
